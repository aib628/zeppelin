...
public class Constants {
    ...
    public static final String INJECT_DONE_CHECK = "injectDoneCheck";
    ...
    public static final Pattern USER_PATTERN = Pattern.compile("\\{([A-Za-z0-9:._]+)\\.user\\}");

    public static final Pattern PASSWORD_PATTERN = Pattern.compile("\\{([A-Za-z0-9:._]+)\\.password\\}");
