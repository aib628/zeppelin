...
import org.apache.zeppelin.flink.shims118.CollectStreamTableSink;
...
/**
 * Shims for flink 1.18
 */
public class Flink118Shims extends FlinkShims {

  private static final Logger LOGGER = LoggerFactory.getLogger(Flink118Shims.class);

  private Flink118SqlInterpreter batchSqlInterpreter;
  private Flink118SqlInterpreter streamSqlInterpreter;

  public Flink118Shims(FlinkVersion flinkVersion, Properties properties) {
    super(flinkVersion, properties);
  }

  public void initInnerBatchSqlInterpreter(FlinkSqlContext flinkSqlContext) {
    this.batchSqlInterpreter = new Flink118SqlInterpreter(flinkSqlContext, true);
  }

  public void initInnerStreamSqlInterpreter(FlinkSqlContext flinkSqlContext) {
    this.streamSqlInterpreter = new Flink118SqlInterpreter(flinkSqlContext, false);
  }
  ...
  public Object fromDataSet(Object btenv, Object ds) {
    throw new RuntimeException("Conversion from DataSet is not supported in Flink 1.18");
  }

  @Override
  public Object toDataSet(Object btenv, Object table) {
    throw new RuntimeException("Conversion to DataSet is not supported in Flink 1.18");
  }
